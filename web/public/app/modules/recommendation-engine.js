...
var RecommendationEngine = (function() {
  ...
  function buildTodayActions(profile) {
    ...
    return [
      {
        id: 'agua',         label: 'Agua',
        detail: waterL + 'L de ' + waterTarget + 'L',
        ...
        action: null, href: '/app/checklist'
      },
      {
        id: 'calorias',     label: 'Calorías del día',
        ...
        action: null, href: '/app/plan'
      },
      {
        id: 'proteina',     label: 'Proteína',
        detail: consumed.prot + 'g de ' + protTarget + 'g',
      ...
      },
      {
        ...
        action: null, href: '/app/entrenamientos'
      },
      {
        id: 'suplementos',  label: 'Suplementos',
        detail: checklist.suplementos ? 'Tomados hoy' : 'Pendiente',
        icon: 'medication', iconColor: '#c084fc',
        done: !!checklist.suplementos,
        progress: checklist.suplementos ? 100 : 0,
        action: null, href: '/app/suplementos'
      },
      {
